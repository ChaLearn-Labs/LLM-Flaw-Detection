prompt_1 = """
You are an expert paper reviewer and are provided with a paper in HTML format. 

Task:
-----
- Carefully examine the paper and detect any flaws matching the criteria below.
...
Instructions:
-------------
After review, return **a valid JSON array** of objects for all identified flaws. Each object must include:
...
- Each object in the array should exactly follow the specified fields: 
  start_of_flaw, end_of_flaw, flaw_category, flaw_description, flaw_severity, flaw_confidence.
